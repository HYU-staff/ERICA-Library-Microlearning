...
export default function AdminPage(){
  ...
  const upload=async()=>{
    ...
    if(tags.length>10||tags.some((tag)=>tag.length>30))return setUploadStatus("태그는 최대 10개, 태그당 30자까지 입력할 수 있습니다.");
    try{
